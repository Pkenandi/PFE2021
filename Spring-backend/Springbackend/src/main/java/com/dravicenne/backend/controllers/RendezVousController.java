...
public class RendezVousController {
    ...
    public RendezVousDto findWithMedecinAndPatient(@PathVariable final String cin,
                                                                   @PathVariable final String username) {
        return RendezVousDto.from(
                this.rendezVousService.findByPatient_UsernameAndMedecin_Cin(cin, username)
        );
    }
}